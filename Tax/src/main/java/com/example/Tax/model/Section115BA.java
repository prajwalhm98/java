...
@Entity
@Table(name="Section115BA")
public class Section115BA {
	...
	public Section115BA(Long id, String companyName, long companyIncome, long deductions, long tax_Payable, long income,
			long surCharge, long cess, long tax) {
		super();
		this.id = id;
		this.companyName = companyName;
		this.companyIncome = companyIncome;
